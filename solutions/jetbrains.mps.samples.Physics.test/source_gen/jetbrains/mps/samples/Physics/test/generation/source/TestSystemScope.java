...
public class TestSystemScope extends SystemScope {
  ...
  public static class A2PhysicalEntity extends BaseObjectAbstractEntity<TestSystemScope> {
    ...
    public void init(final TestSystemScope scope, final World world) {
      ...
      this.getBody().setLinearVel(VectorHelper.fromInternal(scope.getAbsoluteInitialVelocity(new InternalVector(((Number) (AH.mul(((Number) new BigDecimal("2.628655560595668030128345424239383").setScale(33, RoundingMode.DOWN)), ((Number) new BigInteger("1"))))), ((Number) (AH.mul(((Number) new BigDecimal("0E-69").setScale(0, RoundingMode.DOWN)), ((Number) new BigInteger("1"))))), ((Number) (AH.mul(((Number) new BigDecimal("-4.253254041760199660907702485315056").setScale(33, RoundingMode.DOWN)), ((Number) new BigInteger("1")))))))));
