...
public class TestConversions_Test extends BaseTransformationTest {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_ResolveDirectionalOutsidePosition() throws Exception {
      ...
      addNodeById("1139474844806327647");
      addNodeById("1139474844806955740");
      this.assertEquals(SNodeOperations.cast(getNodeById("6610288360169093239"), SNodeOperations.asSConcept(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xbe81eb124eda4d0eL, 0x89be7493500ab874L, "jetbrains.mps.samples.Physics"), 0xb0d6374ec7f738eL, "TargetableObjectExpression"))), new InternalVector(-3, -3 * Math.sqrt(3), -3 / 2 * Math.sqrt(3)));
    }
