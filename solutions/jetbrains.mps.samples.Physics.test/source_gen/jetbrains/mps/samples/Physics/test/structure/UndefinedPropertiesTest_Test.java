...
public class UndefinedPropertiesTest_Test extends BaseTransformationTest {
  @ClassRule
  public static final TestParametersCache ourParamCache = new TestParametersCache(UndefinedPropertiesTest_Test.class, "${jetbrains.mps.samples.Physics.home}", "r:0aef0149-b947-489c-9913-1dba741f6bbb(jetbrains.mps.samples.Physics.test.structure@tests)", false);
  @Rule
