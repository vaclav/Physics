...
public abstract class BaseObjectAbstractEntity<T extends SystemScope> extends PhysicalEntity<T> {
  ...
  public void init(T scope, World world) {
    ...
    propertiesBuilder.set(PropKey.SPHERE_RADIUS, AH.mul(BigDecimal.valueOf(Math.pow(new BigDecimal().doubleValue(), 1 / new BigDecimal("3").doubleValue())), ((Number) (AH.mul(((Number) new BigInteger("1")), ((Number) new BigInteger("1")))))));
