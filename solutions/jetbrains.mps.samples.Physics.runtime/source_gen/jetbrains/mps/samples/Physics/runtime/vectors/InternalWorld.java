...
public class InternalWorld extends InternalEntity<SNode> {
  ...
  public SNode getMassCenter() {
    ...
    SNode firstMass = createMulExpression_lndn4q_a0e0c(massExpressionOf(Sequence.fromIterable(scope).first()), SNodeOperations.copyNode(SLinkOperations.getTarget(SLinkOperations.getTarget(Sequence.fromIterable(scope).first(), LINKS.position$DoV0), LINKS.expression$87ts)));
    ...
    SNode sum = Sequence.fromIterable(scope).skip(1).foldLeft(firstMass, new ILeftCombinator<SNode, SNode>() {
      public SNode combine(SNode s, SNode it) {
        return createPlusExpression_lndn4q_a0a0a0a7a2(s, massExpressionOf(it), SNodeOperations.copyNode(SLinkOperations.getTarget(SLinkOperations.getTarget(it, LINKS.position$DoV0), LINKS.expression$87ts)));
      }
    });
