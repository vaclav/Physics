...
public class Javascript_ApplicationPlugin extends BaseApplicationPlugin {
  private final PluginId myId = PluginId.getId("jetbrains.mps.samples.Physics.execution.javascript");

  public Javascript_ApplicationPlugin() {
  }
