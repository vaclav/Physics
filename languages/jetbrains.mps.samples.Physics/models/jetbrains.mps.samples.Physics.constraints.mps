...
<model ref="r:1f53c291-43e8-4aee-8e7e-323793ae72d7(jetbrains.mps.samples.Physics.constraints)">
  ...
  <node concept="1M2fIO" id="1jQexh3yYvN">
    <property role="3GE5qa" value="physical.vector.base" />
    <ref role="1M2myG" to="9tcj:1jQexh3yYuK" resolve="VectorBase" />
    <ref role="1MND4H" to="9tcj:1jQexh3yYuN" resolve="FromOrientationVectorBase" />
  </node>
</model>
