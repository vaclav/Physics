...
public class FallingBallSimulation extends Simulation {
  ...
  public VectorLike getCameraPosition(PGraphics graphics) {
    ...
    return new InternalVector(((Number) new BigInteger("0")), ((Number) (AH.mul(((Number) new BigInteger("20")), ((Number) new BigInteger("1"))))), ((Number) (AH.mul(((Number) new BigInteger("300")), ((Number) new BigInteger("1"))))));
  }
