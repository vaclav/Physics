...
public class TestWorldSystemScope extends SystemScope {
  ...
  public TestWorldSystemScope(World world, VectorLike position, VectorLike velocity) {
    ...
    TheOtherWorld = withEntity(new World2SystemScope(world, position.add(new InternalVector(AH.mul(((Number) new BigInteger("1")), new BigDecimal("1")), AH.mul(((Number) new BigInteger("1")), new BigDecimal("1")), AH.mul(((Number) new BigInteger("1")), new BigDecimal("1")))), velocity.add(InternalVector.ZERO)));
  ...
  public static class Something5PhysicalEntity extends ObjectSupertypeAbstractEntity<TestWorldSystemScope> {
    ...
    public void init(final TestWorldSystemScope scope, final World world) {
      ...
      propertiesBuilder.set(PropKey.BOX_X, AH.mul(((Number) new BigInteger("2")), new BigDecimal("1")));
      propertiesBuilder.set(PropKey.BOX_Y, AH.mul(((Number) new BigInteger("2")), new BigDecimal("1")));
      propertiesBuilder.set(PropKey.BOX_Z, AH.mul(((Number) new BigInteger("2")), new BigDecimal("1")));
      this.getForces().addAll(Arrays.asList(new Force<TestWorldSystemScope>() {
        ...
        public DVector3C linearForce(World world, TestWorldSystemScope scope, PhysicalEntity currentEntity, double time) {
          if (cached == null) {
            cached = new InternalVector(AH.mul(((Number) new BigInteger("2")), new BigDecimal("1")), AH.mul(((Number) new BigInteger("2")), new BigDecimal("1")), AH.mul(((Number) new BigInteger("2")), new BigDecimal("1")));
          }
        ...
        public DVector3C linearForce(World world, TestWorldSystemScope scope, PhysicalEntity currentEntity, double time) {
          ...
          return VectorHelper.anyToDVector3C(scope.Hey.minus(currentEntity).resize(AH.mul(((Number) new BigInteger("3")), new BigDecimal("1"))));
        }
        ...
        @Override
        public DVector3C linearForce(World world, TestWorldSystemScope scope, PhysicalEntity currentEntity, double time) {
          cached = GravityForce.get(world, scope, currentEntity, time, AH.mul(((Number) new BigInteger("4")), AH.mul(((Number) new BigInteger("1")), new BigDecimal("1"))));
        ...
        @Override
        public DVector3C linearForce(World world, TestWorldSystemScope scope, PhysicalEntity currentEntity, double time) {
          cached = XYZForceForce.get(world, scope, currentEntity, time, AH.mul(((Number) new BigInteger("4")), new BigDecimal("1")), AH.mul(((Number) new BigInteger("4")), new BigDecimal("1")), AH.mul(((Number) new BigInteger("4")), new BigDecimal("1")));
  ...
  public static class Hey2PhysicalEntity extends BaseObjectAbstractEntity<TestWorldSystemScope> {
    ...
    public void init(final TestWorldSystemScope scope, final World world) {
      ...
      this.setMass(AH.mul(((Number) new BigInteger("212")), new BigDecimal("1")));
      this.getBody().setPosition(VectorHelper.fromInternal(new InternalVector(AH.mul(((Number) new BigDecimal("27.46035823174609274397702460056475").setScale(32, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigDecimal("-90.282140454466024179938468351046636").setScale(33, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigDecimal("5.627543496627525070275583761154096").setScale(33, RoundingMode.DOWN)), new BigDecimal("1"))).add(scope.getInitialPosition())));
      this.getBody().setLinearVel(VectorHelper.fromInternal(scope.getInitialVelocity()));
      ...
      propertiesBuilder.set(PropKey.TEXTURE, new ColorTexture(new Color(255, 255, 255), null));
      propertiesBuilder.set(PropKey.SPHERE_RADIUS, AH.mul(((Number) new BigInteger("50")), new BigDecimal("1")));
  ...
  public static class Ho2PhysicalEntity extends BaseObjectAbstractEntity<TestWorldSystemScope> {
    ...
    public void init(final TestWorldSystemScope scope, final World world) {
      ...
      this.setMass(AH.mul(((Number) new BigInteger("120")), new BigDecimal("1")));
      this.getBody().setPosition(VectorHelper.fromInternal(InternalVector.fromSpherical(AH.mul(((Number) new BigInteger("30")), new BigDecimal("1")), AH.mul(((Number) new BigInteger("6")), new BigDecimal("1")), AH.mul(((Number) new BigInteger("80")), new BigDecimal("1"))).add(scope.getInitialPosition())));
      this.getBody().setLinearVel(VectorHelper.fromInternal(scope.getInitialVelocity()));
      ...
      propertiesBuilder.set(PropKey.SHAPE, "sphere");
      propertiesBuilder.set(PropKey.TEXTURE, new ColorTexture(new Color(255, 255, 255), null));
      propertiesBuilder.set(PropKey.SPHERE_RADIUS, AH.mul(((Number) new BigInteger("300")), new BigDecimal("1")));
      this.getForces().addAll(Arrays.asList());
    }
  }
