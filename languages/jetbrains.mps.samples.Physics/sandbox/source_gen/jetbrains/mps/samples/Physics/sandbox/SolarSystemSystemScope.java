...
public class SolarSystemSystemScope extends SystemScope {
  ...
  public static class Sun2PhysicalEntity extends PlanetAbstractEntity<SolarSystemSystemScope> {
    ...
    public void init(final SolarSystemSystemScope scope, final World world) {
      ...
      this.getBody().setPosition(VectorHelper.fromInternal(new InternalVector(AH.mul(((Number) new BigDecimal("0.001").setScale(3, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigInteger("0")), new BigDecimal("1")), AH.mul(((Number) new BigInteger("0")), new BigDecimal("1"))).add(scope.getInitialPosition())));
  ...
  public static class Mercury2PhysicalEntity extends PlanetAbstractEntity<SolarSystemSystemScope> {
    ...
    public void init(final SolarSystemSystemScope scope, final World world) {
      ...
      this.getBody().setPosition(VectorHelper.fromInternal(new InternalVector(AH.mul(((Number) new BigDecimal("500.001").setScale(3, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigInteger("6")), new BigDecimal("1")), AH.mul(((Number) new BigInteger("7")), new BigDecimal("1"))).add(scope.getInitialPosition())));
      this.getBody().setLinearVel(VectorHelper.fromInternal(scope.getInitialVelocity()));
  ...
  public static class Venus2PhysicalEntity extends PlanetAbstractEntity<SolarSystemSystemScope> {
    ...
    public void init(final SolarSystemSystemScope scope, final World world) {
      ...
      this.getBody().setPosition(VectorHelper.fromInternal(new InternalVector(AH.mul(((Number) new BigDecimal("-270.05828892065526").setScale(14, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigDecimal("38.496018060737015").setScale(15, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigDecimal("-124.84405096414272").setScale(14, RoundingMode.DOWN)), new BigDecimal("1"))).add(scope.getInitialPosition())));
      this.getBody().setLinearVel(VectorHelper.fromInternal(new InternalVector(AH.mul(((Number) new BigInteger("3")), new BigDecimal("1")), AH.mul(((Number) new BigInteger("3")), new BigDecimal("1")), AH.mul(((Number) new BigInteger("3")), new BigDecimal("1"))).add(scope.getInitialVelocity())));
  ...
  public static class Earth2PhysicalEntity extends PlanetAbstractEntity<SolarSystemSystemScope> {
    ...
    public void init(final SolarSystemSystemScope scope, final World world) {
      ...
      this.getBody().setPosition(VectorHelper.fromInternal(new InternalVector(AH.mul(((Number) new BigDecimal("0.00099999999975507064017052935").setScale(29, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigDecimal("2.9995195653237156E-29").setScale(20, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigDecimal("-400.0").setScale(1, RoundingMode.DOWN)), new BigDecimal("1"))).add(scope.getInitialPosition())));
      this.getBody().setLinearVel(VectorHelper.fromInternal(new InternalVector(AH.mul(((Number) new BigInteger("5")), new BigDecimal("1")), AH.mul(((Number) new BigInteger("1")), new BigDecimal("1")), AH.mul(((Number) new BigInteger("1")), new BigDecimal("1"))).add(scope.getInitialVelocity())));
  ...
  public static class Moon2PhysicalEntity extends PlanetAbstractEntity<SolarSystemSystemScope> {
    ...
    public void init(final SolarSystemSystemScope scope, final World world) {
      ...
      this.getBody().setPosition(VectorHelper.fromInternal(new InternalVector(AH.mul(((Number) new BigDecimal("-54.40111108893722492935982947065").setScale(29, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigDecimal("183.9071529076452400000000000000300").setScale(31, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigDecimal("-343.26756290735475").setScale(14, RoundingMode.DOWN)), new BigDecimal("1"))).add(scope.getInitialPosition())));
      this.getBody().setLinearVel(VectorHelper.fromInternal(scope.getInitialVelocity()));
      ...
      propertiesBuilder.set(PropKey.BOX_X, AH.mul(((Number) new BigInteger("4")), new BigDecimal("1")));
      propertiesBuilder.set(PropKey.BOX_Y, AH.mul(((Number) new BigInteger("4")), new BigDecimal("1")));
      propertiesBuilder.set(PropKey.BOX_Z, AH.mul(((Number) new BigInteger("4")), new BigDecimal("1")));
      this.getForces().addAll(Arrays.asList());
    }
  }
  public static class Mars2PhysicalEntity extends PlanetAbstractEntity<SolarSystemSystemScope> {
    ...
    public void init(final SolarSystemSystemScope scope, final World world) {
      ...
      this.getBody().setPosition(VectorHelper.fromInternal(new InternalVector(AH.mul(((Number) new BigDecimal("-58.70883489445973").setScale(14, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigDecimal("-95.09511422778161").setScale(14, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigDecimal("-165.86196657263002").setScale(14, RoundingMode.DOWN)), new BigDecimal("1"))).add(scope.getInitialPosition())));
      this.getBody().setLinearVel(VectorHelper.fromInternal(scope.getInitialVelocity()));
