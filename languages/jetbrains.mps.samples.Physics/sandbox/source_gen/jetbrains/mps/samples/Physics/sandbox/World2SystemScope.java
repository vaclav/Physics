    ...
    public void init(final World2SystemScope scope, final World world) {
      ...
      this.getForces().addAll(Arrays.asList(new Force<World2SystemScope>() {
        ...
        public DVector3C linearForce(World world, World2SystemScope scope, PhysicalEntity currentEntity, double time) {
          ...
          return VectorHelper.toDVector3C(scope.Ha.minus(currentEntity).resize(((Number) (AH.mul(((Number) new BigDecimal("0.1").setScale(1, RoundingMode.DOWN)), ((Number) new BigInteger("1")))))));
        }
    ...
    public void init(final World2SystemScope scope, final World world) {
      ...
      this.getForces().addAll(Arrays.asList(new Force<World2SystemScope>() {
        ...
        public DVector3C linearForce(World world, World2SystemScope scope, PhysicalEntity currentEntity, double time) {
          ...
          return VectorHelper.toDVector3C(scope.Ho3.minus(currentEntity).resize(((Number) (AH.mul(((Number) new BigDecimal("0.1").setScale(1, RoundingMode.DOWN)), ((Number) new BigInteger("1")))))));
        }
