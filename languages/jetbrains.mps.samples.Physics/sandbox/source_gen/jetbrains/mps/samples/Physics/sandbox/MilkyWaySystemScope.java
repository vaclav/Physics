...
public class MilkyWaySystemScope extends SystemScope {
  ...
  public MilkyWaySystemScope(World world, VectorLike position, VectorLike velocity) {
    ...
    SolarSystem1 = withEntity(new SolarSystemSystemScope(world, position.add(new InternalVector(AH.mul(((Number) new BigDecimal("4.999999999999999").setScale(15, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigDecimal("4.0").setScale(1, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigDecimal("4.0").setScale(1, RoundingMode.DOWN)), new BigDecimal("1")))), velocity.add(InternalVector.ZERO)));
  ...
  public static class FloatingDog2PhysicalEntity extends RandomObjectAbstractEntity<MilkyWaySystemScope> {
    ...
    public void init(final MilkyWaySystemScope scope, final World world) {
      ...
      this.getBody().setPosition(VectorHelper.fromInternal(new InternalVector(AH.mul(((Number) new BigDecimal("8.999999999999999").setScale(15, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigDecimal("50004.0").setScale(1, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigDecimal("10.0").setScale(1, RoundingMode.DOWN)), new BigDecimal("1"))).add(scope.getInitialPosition())));
  ...
  public static class Something2PhysicalEntity extends RandomObjectAbstractEntity<MilkyWaySystemScope> {
    ...
    public void init(final MilkyWaySystemScope scope, final World world) {
      ...
      this.setMass(((Number) new BigInteger("30")));
      this.getBody().setPosition(VectorHelper.fromInternal(new InternalVector(AH.mul(((Number) new BigDecimal("0.008099351758686229689152452006379259").setScale(36, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigDecimal("44.99999837126069715293084237640952").setScale(32, RoundingMode.DOWN)), new BigDecimal("1")), AH.mul(((Number) new BigDecimal("0.008999279731873589543422694659709127").setScale(36, RoundingMode.DOWN)), new BigDecimal("1"))).add(scope.getInitialPosition())));
      this.getBody().setLinearVel(VectorHelper.fromInternal(scope.getInitialVelocity()));
