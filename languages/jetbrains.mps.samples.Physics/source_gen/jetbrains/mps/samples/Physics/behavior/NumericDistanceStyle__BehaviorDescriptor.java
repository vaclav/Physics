...
public final class NumericDistanceStyle__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xbe81eb124eda4d0eL, 0x89be7493500ab874L, 0x101711d6977a709aL, "jetbrains.mps.samples.Physics.structure.NumericDistanceStyle");
  ...
  /*package*/ static Iterable<List<SNode>> getRequiredDimensions_id270Q2mETulL(@NotNull SNode __thisNode__) {
    return Sequence.<List<SNode>>singleton(SLinkOperations.getChildren((_quotation_createNode_6x31m9_a0a0a0a0()), LINKS.units$o6Ow));
  }

  /*package*/ NumericDistanceStyle__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_6x31m9_a0a0a0a0() {
