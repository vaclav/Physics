...
public final class VelocityVector__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xbe81eb124eda4d0eL, 0x89be7493500ab874L, 0xb0d6374ec7f738bL, "jetbrains.mps.samples.Physics.structure.VelocityVector");
  ...
  /*package*/ static Iterable<List<SNode>> getRequiredDimensions_id270Q2mETulL(@NotNull SNode __thisNode__) {
    return Sequence.<List<SNode>>singleton(SLinkOperations.getChildren((_quotation_createNode_tbdp5k_a0a0a0a0()), LINKS.units$o6Ow));
  }

  /*package*/ VelocityVector__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_tbdp5k_a0a0a0a0() {
