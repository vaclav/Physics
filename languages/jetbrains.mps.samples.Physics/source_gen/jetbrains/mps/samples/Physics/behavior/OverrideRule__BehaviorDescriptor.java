...
public final class OverrideRule__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> apply_id2AM6gIjLTgr = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("apply").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("2AM6gIjLTgr").build();
  public static final SMethod<SNode> getTarget_id2AM6gIjLTgY = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getTarget").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("2AM6gIjLTgY").build();
