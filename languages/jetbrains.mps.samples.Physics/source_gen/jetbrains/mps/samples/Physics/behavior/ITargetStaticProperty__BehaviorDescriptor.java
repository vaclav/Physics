...
public final class ITargetStaticProperty__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getInterfaceConcept(0xbe81eb124eda4d0eL, 0x89be7493500ab874L, 0xb0d6374ec8ab507L, "jetbrains.mps.samples.Physics.structure.ITargetStaticProperty");
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getTargetCoordinates_idGdoRjGvovH);

  private static void ___init___(@NotNull SNode __thisNode__) {
  }

  /*package*/ static SNode getTargetCoordinates_idGdoRjGvovH(@NotNull SNode __thisNode__, SNode object) {
    // As the current node targets a static property (that cannot reference other coordinates) 
    // we can return null 
    return null;
  }

  /*package*/ ITargetStaticProperty__BehaviorDescriptor() {
  }
