...
public final class WorldDefinition__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Iterable<SNode>> getNestedDefinitions_id31HEEbbzg2E = new SMethodBuilder<Iterable<SNode>>(new SJavaCompoundTypeImpl((Class<Iterable<SNode>>) ((Class) Object.class))).name("getNestedDefinitions").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("31HEEbbzg2E").build();
  public static final SMethod<Iterable<SNode>> getLocalizedObjects_id31HEEbbX5J7 = new SMethodBuilder<Iterable<SNode>>(new SJavaCompoundTypeImpl((Class<Iterable<SNode>>) ((Class) Object.class))).name("getLocalizedObjects").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("31HEEbbX5J7").build();
  ...
  public static final SMethod<SNode> getCurrentWorldDefinition_id2bZvtzzMfxi = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getDefinition").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("2bZvtzzMfxi").build();
