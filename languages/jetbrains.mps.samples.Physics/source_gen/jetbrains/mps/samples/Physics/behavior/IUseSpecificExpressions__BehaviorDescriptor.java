...
public final class IUseSpecificExpressions__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SAbstractConcept> getSpecificExpressionConcept_id1AxJyXYWKCb = new SMethodBuilder<SAbstractConcept>(new SJavaCompoundTypeImpl((Class<SAbstractConcept>) ((Class) Object.class))).name("getSpecificExpressionConcept").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1AxJyXYWKCb").build();
