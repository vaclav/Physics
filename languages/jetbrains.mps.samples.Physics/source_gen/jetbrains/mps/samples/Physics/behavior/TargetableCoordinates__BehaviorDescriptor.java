...
public final class TargetableCoordinates__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xbe81eb124eda4d0eL, 0x89be7493500ab874L, 0xb0d6374ec7f738eL, "jetbrains.mps.samples.Physics.structure.TargetableCoordinates");
        ...
        // If the source targets an object 
        {
          ...
          if (SNodeOperations.isInstanceOf(object, CONCEPTS.ITargetObject$lA)) {
            ...
            // And the target target specific coordinates 
            {
              ...
              if (SNodeOperations.isInstanceOf(target, CONCEPTS.ITargetCoordinates$__)) {
                // Use those 
                return ITargetCoordinates__BehaviorDescriptor.getTargetCoordinates_idGdoRjGvovH.invoke(target, ITargetObject__BehaviorDescriptor.getTargetLocalizedObject_idGdoRjGrk0_.invoke(object));
              }
            }
  ...
  /*package*/ TargetableCoordinates__BehaviorDescriptor() {
  }
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SInterfaceConcept ITargetCoordinates$__ = MetaAdapterFactory.getInterfaceConcept(0xbe81eb124eda4d0eL, 0x89be7493500ab874L, 0xb0d6374ec7d87e1L, "jetbrains.mps.samples.Physics.structure.ITargetCoordinates");
