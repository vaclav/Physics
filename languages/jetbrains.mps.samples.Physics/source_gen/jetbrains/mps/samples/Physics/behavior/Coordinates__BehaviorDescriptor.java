...
public final class Coordinates__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static Iterable<List<SNode>> getRequiredDimensions_id270Q2mETulL(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(list).addElement(SLinkOperations.getChildren((_quotation_createNode_ouciej_a0a0a1a0()), LINKS.units$o6Ow));
    ListSequence.fromList(list).addElement(SLinkOperations.getChildren((_quotation_createNode_ouciej_a0a0a2a0()), LINKS.units$o6Ow));
    return list;
  }
  ...
  private static SNode _quotation_createNode_ouciej_a0a0a1a0() {
  ...
  private static SNode _quotation_createNode_ouciej_a0a0a2a0() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_1 = null;
    SNode quotedNode_2 = null;
    SNode quotedNode_3 = null;
