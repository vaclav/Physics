...
public class StylesHelper {
  ...
  public static boolean isExpressionOfConcept(SAbstractConcept nodeConcept, SAbstractConcept filterConcept) {
    return !(SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(nodeConcept), CONCEPTS.Expression$Wr)) || SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(nodeConcept), SNodeOperations.asSConcept(filterConcept));
  }
