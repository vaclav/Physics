...
public class GrammarCellsSubstituteMenu_VectorResizeDotTarget extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_VectorResizeDotTarget() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_9rjbcz_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "VectorResizeDotTarget", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_9rjbcz_a extends GrammarCellsSubstituteMenuPart {
    @Override
