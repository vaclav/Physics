...
public class GrammarCellsSubstituteMenu_VectorOppositeTarget extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_VectorOppositeTarget() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_xjjkgb_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "VectorOppositeTarget", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_xjjkgb_a extends GrammarCellsSubstituteMenuPart {
    @Override
