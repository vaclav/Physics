...
public class GrammarCellsSubstituteMenu_DirectionalCoordinates extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_DirectionalCoordinates() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_hjucx2_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "DirectionalCoordinates", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_hjucx2_a extends GrammarCellsSubstituteMenuPart {
    @Override
