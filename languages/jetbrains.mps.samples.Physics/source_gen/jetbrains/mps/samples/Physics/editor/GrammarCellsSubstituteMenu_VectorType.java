...
public class GrammarCellsSubstituteMenu_VectorType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_VectorType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_slnusc_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "VectorType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_slnusc_a extends GrammarCellsSubstituteMenuPart {
    @Override
