...
public class GrammarCellsSubstituteMenu_ForceType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ForceType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_p0crro_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ForceType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_p0crro_a extends GrammarCellsSubstituteMenuPart {
    @Override
