...
public class GrammarCellsSubstituteMenu_RelativeCoordinates extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_RelativeCoordinates() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_m062yh_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "RelativeCoordinates", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_m062yh_a extends GrammarCellsSubstituteMenuPart {
    @Override
