...
public class GrammarCellsSubstituteMenu_AbsoluteCoordinates extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AbsoluteCoordinates() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_44gqlw_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AbsoluteCoordinates", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_44gqlw_a extends GrammarCellsSubstituteMenuPart {
    @Override
