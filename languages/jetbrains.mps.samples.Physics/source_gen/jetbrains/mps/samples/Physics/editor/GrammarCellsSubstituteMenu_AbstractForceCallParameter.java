...
public class GrammarCellsSubstituteMenu_AbstractForceCallParameter extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AbstractForceCallParameter() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_87ikv_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for AbstractForceCallParameter. Generated from implicit smart reference attribute.", new SNodePointer("r:536344e4-f692-450c-bc6e-ea4e11701e75(jetbrains.mps.samples.Physics.structure)", "974138438729123585")));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_87ikv_a extends GrammarCellsSubstituteMenuPart {
    @Override
