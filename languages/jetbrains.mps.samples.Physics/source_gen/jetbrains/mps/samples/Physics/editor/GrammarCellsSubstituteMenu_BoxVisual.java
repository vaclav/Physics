...
public class GrammarCellsSubstituteMenu_BoxVisual extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BoxVisual() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_j8ohbb_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BoxVisual", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_j8ohbb_a extends GrammarCellsSubstituteMenuPart {
    @Override
