...
public class GrammarCellsSubstituteMenu_IObjectDefinition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IObjectDefinition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_7jhg8f_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IObjectDefinition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_7jhg8f_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.IObjectDefinition$Ei;
    }
  }
