...
public class GrammarCellsSubstituteMenu_VectorComponentTarget extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_VectorComponentTarget() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_cfvqvb_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "VectorComponentTarget", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_cfvqvb_a extends GrammarCellsSubstituteMenuPart {
    @Override
