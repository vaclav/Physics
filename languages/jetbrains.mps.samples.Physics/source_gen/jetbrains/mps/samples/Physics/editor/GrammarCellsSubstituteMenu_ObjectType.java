...
public class GrammarCellsSubstituteMenu_ObjectType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ObjectType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_1r7b16_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ObjectType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_1r7b16_a extends GrammarCellsSubstituteMenuPart {
    @Override
