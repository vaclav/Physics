...
public class GrammarCellsSubstituteMenu_ObjectDefinition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ObjectDefinition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_pi2s93_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ObjectDefinition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_pi2s93_a extends GrammarCellsSubstituteMenuPart {
    @Override
