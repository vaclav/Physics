...
public class GrammarCellsSubstituteMenu_StaticForce extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_StaticForce() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_162pfk_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "StaticForce", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_162pfk_a extends GrammarCellsSubstituteMenuPart {
    @Override
