...
public class GrammarCellsSubstituteMenu_VelocityCoordinates extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_VelocityCoordinates() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_xdbpy9_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "VelocityCoordinates", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_xdbpy9_a extends GrammarCellsSubstituteMenuPart {
    @Override
