...
public class GrammarCellsSubstituteMenu_CylindricalCoordinates extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_CylindricalCoordinates() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_2aj810_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "CylindricalCoordinates", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_2aj810_a extends GrammarCellsSubstituteMenuPart {
    @Override
