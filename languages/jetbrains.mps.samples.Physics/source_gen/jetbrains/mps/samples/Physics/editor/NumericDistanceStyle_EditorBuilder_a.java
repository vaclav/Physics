...
/*package*/ class NumericDistanceStyle_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public NumericDistanceStyle_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_fkek5a_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_fkek5a_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new valueSingleRoleHandler_fkek5a_c0(myNode, LINKS.value$aRGu, getEditorContext());
    return provider.createCell();
  }
  private static class valueSingleRoleHandler_fkek5a_c0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public valueSingleRoleHandler_fkek5a_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
