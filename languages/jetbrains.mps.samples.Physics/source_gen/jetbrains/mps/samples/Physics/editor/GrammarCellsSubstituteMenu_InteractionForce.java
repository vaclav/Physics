...
public class GrammarCellsSubstituteMenu_InteractionForce extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_InteractionForce() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_ks3ybu_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "InteractionForce", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_ks3ybu_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.InteractionForce$dQ;
    }
  }
