...
public class GrammarCellsSubstituteMenu_SphereShape extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_SphereShape() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_23qcv0_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "SphereShape", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_23qcv0_a extends GrammarCellsSubstituteMenuPart {
    @Override
