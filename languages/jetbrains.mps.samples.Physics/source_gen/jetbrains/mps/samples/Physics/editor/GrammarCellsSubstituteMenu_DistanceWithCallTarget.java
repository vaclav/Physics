...
public class GrammarCellsSubstituteMenu_DistanceWithCallTarget extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_DistanceWithCallTarget() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_4jx2cz_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "DistanceWithCallTarget", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_4jx2cz_a extends GrammarCellsSubstituteMenuPart {
    @Override
