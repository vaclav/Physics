...
public class GrammarCellsSubstituteMenu_WorldType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_WorldType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_lnq6g8_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "WorldType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_lnq6g8_a extends GrammarCellsSubstituteMenuPart {
    @Override
