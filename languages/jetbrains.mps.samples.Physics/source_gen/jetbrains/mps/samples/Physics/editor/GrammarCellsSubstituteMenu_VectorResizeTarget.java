...
public class GrammarCellsSubstituteMenu_VectorResizeTarget extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_VectorResizeTarget() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_u58jsi_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "VectorResizeTarget", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_u58jsi_a extends GrammarCellsSubstituteMenuPart {
    @Override
