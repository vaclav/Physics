...
public class GrammarCellsSubstituteMenu_TargetableExpression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_TargetableExpression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_3tcl6n_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "TargetableExpression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_3tcl6n_a extends GrammarCellsSubstituteMenuPart {
    @Override
