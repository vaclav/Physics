...
public class GrammarCellsSubstituteMenu_IProvideCurrentWorld extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IProvideCurrentWorld() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_wpyjqe_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IProvideCurrentWorld", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_wpyjqe_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.IProvideCurrentWorld$2_;
    }
  }
