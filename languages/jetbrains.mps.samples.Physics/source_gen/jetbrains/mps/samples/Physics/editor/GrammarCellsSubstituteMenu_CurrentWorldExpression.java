...
public class GrammarCellsSubstituteMenu_CurrentWorldExpression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_CurrentWorldExpression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_qw2vq_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "CurrentWorldExpression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_qw2vq_a extends GrammarCellsSubstituteMenuPart {
    @Override
