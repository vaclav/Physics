...
public class GrammarCellsSubstituteMenu_AbstractForceCall extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AbstractForceCall() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_ny1qg5_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AbstractForceCall", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_ny1qg5_a extends GrammarCellsSubstituteMenuPart {
    @Override
