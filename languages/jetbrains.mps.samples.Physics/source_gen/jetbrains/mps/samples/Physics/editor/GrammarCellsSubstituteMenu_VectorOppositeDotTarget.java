...
public class GrammarCellsSubstituteMenu_VectorOppositeDotTarget extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_VectorOppositeDotTarget() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_2e1nsq_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "VectorOppositeDotTarget", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_2e1nsq_a extends GrammarCellsSubstituteMenuPart {
    @Override
