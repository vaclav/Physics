...
public class GrammarCellsSubstituteMenu_TimeExpression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_TimeExpression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_1526k0_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "TimeExpression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_1526k0_a extends GrammarCellsSubstituteMenuPart {
    @Override
