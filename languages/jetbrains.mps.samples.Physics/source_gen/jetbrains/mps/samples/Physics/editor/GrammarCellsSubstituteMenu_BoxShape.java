...
public class GrammarCellsSubstituteMenu_BoxShape extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BoxShape() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_li7dl_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BoxShape", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_li7dl_a extends GrammarCellsSubstituteMenuPart {
    @Override
