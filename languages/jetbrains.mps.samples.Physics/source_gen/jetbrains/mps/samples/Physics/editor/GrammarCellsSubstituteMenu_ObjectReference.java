...
public class GrammarCellsSubstituteMenu_ObjectReference extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ObjectReference() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_cx3daw_a());
    return result;
  }
  ...
  private class GrammarCellsSubstituteMenuPart_cx3daw_a extends GrammarCellsSubstituteMenuPart {
    @Override
