...
public class GrammarCellsSubstituteMenu_ITargetExpression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ITargetExpression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_2dlkvv_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ITargetExpression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_2dlkvv_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ITargetExpression$__;
    }
  }
