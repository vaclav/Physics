...
public class GrammarCellsSubstituteMenu_NumericStyle extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_NumericStyle() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_afz1eo_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "NumericStyle", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_afz1eo_a extends GrammarCellsSubstituteMenuPart {
    @Override
