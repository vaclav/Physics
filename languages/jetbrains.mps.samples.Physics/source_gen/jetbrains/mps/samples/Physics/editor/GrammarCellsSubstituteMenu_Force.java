...
public class GrammarCellsSubstituteMenu_Force extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Force() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_e6hj8n_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Force", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_e6hj8n_a extends GrammarCellsSubstituteMenuPart {
    @Override
