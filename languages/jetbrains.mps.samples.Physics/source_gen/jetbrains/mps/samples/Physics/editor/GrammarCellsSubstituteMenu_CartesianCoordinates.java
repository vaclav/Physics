...
public class GrammarCellsSubstituteMenu_CartesianCoordinates extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_CartesianCoordinates() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_olfl7b_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "CartesianCoordinates", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_olfl7b_a extends GrammarCellsSubstituteMenuPart {
    @Override
