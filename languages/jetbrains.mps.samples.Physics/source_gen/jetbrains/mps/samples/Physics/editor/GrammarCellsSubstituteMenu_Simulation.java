...
public class GrammarCellsSubstituteMenu_Simulation extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Simulation() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_hrmk29_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Simulation", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_hrmk29_a extends GrammarCellsSubstituteMenuPart {
    @Override
