...
public class GrammarCellsSubstituteMenu_Coordinates extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Coordinates() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_9ilui7_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Coordinates", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_9ilui7_a extends GrammarCellsSubstituteMenuPart {
    @Override
