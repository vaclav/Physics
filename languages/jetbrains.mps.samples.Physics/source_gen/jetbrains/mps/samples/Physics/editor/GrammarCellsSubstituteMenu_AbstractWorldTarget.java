...
public class GrammarCellsSubstituteMenu_AbstractWorldTarget extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AbstractWorldTarget() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_dqacwi_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AbstractWorldTarget", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_dqacwi_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.AbstractWorldTarget$FV;
    }
  }
