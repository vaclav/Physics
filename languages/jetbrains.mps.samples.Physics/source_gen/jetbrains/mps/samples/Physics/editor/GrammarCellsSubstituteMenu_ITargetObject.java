...
public class GrammarCellsSubstituteMenu_ITargetObject extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ITargetObject() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_dhgvri_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ITargetObject", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_dhgvri_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ITargetObject$lA;
    }
  }
