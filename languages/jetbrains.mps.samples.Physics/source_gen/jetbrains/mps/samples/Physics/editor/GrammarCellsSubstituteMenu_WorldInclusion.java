...
public class GrammarCellsSubstituteMenu_WorldInclusion extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_WorldInclusion() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_z2bmjn_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "WorldInclusion", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_z2bmjn_a extends GrammarCellsSubstituteMenuPart {
    @Override
