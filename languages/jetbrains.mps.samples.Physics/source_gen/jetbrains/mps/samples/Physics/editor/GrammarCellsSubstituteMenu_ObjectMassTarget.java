...
public class GrammarCellsSubstituteMenu_ObjectMassTarget extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ObjectMassTarget() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_5jjb1s_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ObjectMassTarget", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_5jjb1s_a extends GrammarCellsSubstituteMenuPart {
    @Override
