...
public class GrammarCellsSubstituteMenu_ObjectPositionTarget extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ObjectPositionTarget() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_b57bca_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ObjectPositionTarget", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_b57bca_a extends GrammarCellsSubstituteMenuPart {
    @Override
