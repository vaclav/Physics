...
public class GrammarCellsSubstituteMenu_WorldMassCenterTarget extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_WorldMassCenterTarget() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_dvjws8_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "WorldMassCenterTarget", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_dvjws8_a extends GrammarCellsSubstituteMenuPart {
    @Override
