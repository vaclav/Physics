...
public class GrammarCellsSubstituteMenu_ObjectReferenceExpression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ObjectReferenceExpression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_5wilbo_a());
    return result;
  }
  ...
  private class GrammarCellsSubstituteMenuPart_5wilbo_a extends GrammarCellsSubstituteMenuPart {
    @Override
