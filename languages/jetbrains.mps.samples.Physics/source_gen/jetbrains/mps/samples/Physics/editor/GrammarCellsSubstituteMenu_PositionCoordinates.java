...
public class GrammarCellsSubstituteMenu_PositionCoordinates extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_PositionCoordinates() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_oo85rv_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "PositionCoordinates", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_oo85rv_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.PositionCoordinates$za;
    }
  }
