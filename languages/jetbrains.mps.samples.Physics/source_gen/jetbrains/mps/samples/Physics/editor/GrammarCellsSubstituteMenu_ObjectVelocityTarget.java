...
public class GrammarCellsSubstituteMenu_ObjectVelocityTarget extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ObjectVelocityTarget() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_n2p6ro_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ObjectVelocityTarget", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_n2p6ro_a extends GrammarCellsSubstituteMenuPart {
    @Override
