...
public class GrammarCellsSubstituteMenu_SphericalCoordinates extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_SphericalCoordinates() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_efbwal_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "SphericalCoordinates", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_efbwal_a extends GrammarCellsSubstituteMenuPart {
    @Override
