...
public class GrammarCellsSubstituteMenu_AbstractVectorTarget extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AbstractVectorTarget() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_12zvyh_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AbstractVectorTarget", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_12zvyh_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.AbstractVectorTarget$Ax;
    }
  }
