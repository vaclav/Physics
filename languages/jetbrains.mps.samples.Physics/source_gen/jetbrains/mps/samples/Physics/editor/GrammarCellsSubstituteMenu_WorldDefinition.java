...
public class GrammarCellsSubstituteMenu_WorldDefinition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_WorldDefinition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_632k1g_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "WorldDefinition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_632k1g_a extends GrammarCellsSubstituteMenuPart {
    @Override
