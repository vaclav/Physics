...
public class GrammarCellsSubstituteMenu_DirectionType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_DirectionType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_jfvs9q_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "DirectionType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_jfvs9q_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.DirectionType$vJ;
    }
  }
