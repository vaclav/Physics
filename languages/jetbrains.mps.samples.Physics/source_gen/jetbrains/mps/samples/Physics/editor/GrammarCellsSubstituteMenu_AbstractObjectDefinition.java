...
public class GrammarCellsSubstituteMenu_AbstractObjectDefinition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AbstractObjectDefinition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_h69xgo_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AbstractObjectDefinition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_h69xgo_a extends GrammarCellsSubstituteMenuPart {
    @Override
