...
/*package*/ class CollisionStyle_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public CollisionStyle_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_6msjye_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_6msjye_b0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.reaction$qyMu;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no reaction>");
