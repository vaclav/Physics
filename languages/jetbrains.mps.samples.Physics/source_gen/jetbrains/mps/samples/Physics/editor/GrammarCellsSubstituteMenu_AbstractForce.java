...
public class GrammarCellsSubstituteMenu_AbstractForce extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AbstractForce() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_73srom_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AbstractForce", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_73srom_a extends GrammarCellsSubstituteMenuPart {
    @Override
