...
/*package*/ class ShapeStyle_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ShapeStyle_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_tdeygu_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_tdeygu_b0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.value$E6Vz;
