...
public class GrammarCellsSubstituteMenu_TargetableCoordinates extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_TargetableCoordinates() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_pr5nju_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "TargetableCoordinates", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_pr5nju_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.TargetableCoordinates$cD;
    }
  }
