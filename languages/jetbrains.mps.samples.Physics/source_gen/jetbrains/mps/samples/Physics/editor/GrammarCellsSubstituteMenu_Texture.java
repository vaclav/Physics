...
public class GrammarCellsSubstituteMenu_Texture extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Texture() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_imowu7_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Texture", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_imowu7_a extends GrammarCellsSubstituteMenuPart {
    @Override
