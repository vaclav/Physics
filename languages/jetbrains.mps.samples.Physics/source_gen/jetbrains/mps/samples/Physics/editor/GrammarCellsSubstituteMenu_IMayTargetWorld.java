...
public class GrammarCellsSubstituteMenu_IMayTargetWorld extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IMayTargetWorld() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_bhaeis_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IMayTargetWorld", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_bhaeis_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.IMayTargetWorld$d;
    }
  }
