...
public class GrammarCellsSubstituteMenu_Style extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Style() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_ea3v9m_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Style", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_ea3v9m_a extends GrammarCellsSubstituteMenuPart {
    @Override
