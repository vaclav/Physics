...
public class GrammarCellsSubstituteMenu_CurrentObjectExpression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_CurrentObjectExpression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_i922oq_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "CurrentObjectExpression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_i922oq_a extends GrammarCellsSubstituteMenuPart {
    @Override
