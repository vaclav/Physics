...
public class GrammarCellsSubstituteMenu_ObjectDistanceWithTarget extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ObjectDistanceWithTarget() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_psdydf_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ObjectDistanceWithTarget", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_psdydf_a extends GrammarCellsSubstituteMenuPart {
    @Override
