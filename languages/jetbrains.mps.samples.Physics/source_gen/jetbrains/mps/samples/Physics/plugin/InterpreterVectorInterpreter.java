...
import jetbrains.mps.samples.Physics.runtime.vectors.InternalCurrentWorld;
...
public class InterpreterVectorInterpreter extends InterpreterBase {
  ...
  protected void populateEvaluators(List<? extends IEvaluator> evaluators) {
    ...
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.ObjectReferenceExpression$qq, "r:9d14edd6-e1f4-4462-802b-9d9f72ed6bb8(jetbrains.mps.samples.Physics.plugin)/1481770243885576084", true) {
      public Object evaluateEvaluator(SNode node, IContext context, ICoverageAnalyzer coverage, ComputationTrace trace) {
        try {
          ...
          throw new InterpreterRuntimeException("ObjectReferenceExpression()", node, ex, trace);
        }
      }
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("ObjectReferenceExpression");
      }
    ...
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.WorldNestedObjectTarget$p3, "r:9d14edd6-e1f4-4462-802b-9d9f72ed6bb8(jetbrains.mps.samples.Physics.plugin)/7547499172391892998", true) {
      public Object evaluateEvaluator(SNode node, IContext context, ICoverageAnalyzer coverage, ComputationTrace trace) {
        try {
          ...
          throw new InterpreterRuntimeException("WorldNestedObjectTarget()", node, ex, trace);
        }
      }
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("WorldNestedObjectTarget");
      }

      @Override
      public String toString() {
        return "WorldNestedObjectTarget";
      }
    ...
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.ObjectDistanceWithTarget$OH, "r:9d14edd6-e1f4-4462-802b-9d9f72ed6bb8(jetbrains.mps.samples.Physics.plugin)/3489632902458197367", true, new TypedChildConstraintImpl(LINKS.target$oizF, SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(CONCEPTS.ObjectType$sZ)))) {
      ...
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("ObjectDistanceWithTarget");
      }

      @Override
      public String toString() {
        return "ObjectDistanceWithTarget";
      }
    ...
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.VectorResizeTarget$Am, "r:9d14edd6-e1f4-4462-802b-9d9f72ed6bb8(jetbrains.mps.samples.Physics.plugin)/3489632902464277648", true, new TypedChildConstraintImpl(LINKS.newLength$Gnlv, SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(CONCEPTS.RealType$5o)))) {
      ...
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("VectorResizeTarget");
      }

      @Override
      public String toString() {
        return "VectorResizeTarget";
      }
    ...
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.VectorOppositeTarget$Ac, "r:9d14edd6-e1f4-4462-802b-9d9f72ed6bb8(jetbrains.mps.samples.Physics.plugin)/3489632902458205390", true) {
      ...
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("VectorOppositeTarget");
      }

      @Override
      public String toString() {
        return "VectorOppositeTarget";
      }
    ...
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.CurrentWorldExpression$l8, "r:9d14edd6-e1f4-4462-802b-9d9f72ed6bb8(jetbrains.mps.samples.Physics.plugin)/2521872686839337234", true) {
      public Object evaluateEvaluator(SNode node, IContext context, ICoverageAnalyzer coverage, ComputationTrace trace) {
        try {
          ...
          coverage.visitedConcept(this.concept);
          coverage.visitedConcept(SNodeOperations.getConcept(node));
          return new InternalCurrentWorld(IMayTargetWorld__BehaviorDescriptor.getWorldTarget_id2bZvtzzMbSH.invoke(node));
        } catch (StopAndReturnException stop) {
          return stop.value();
        } catch (InterpreterEscapeException ex) {
          throw ex;
      ...
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("CurrentWorldExpression");
      }

      @Override
      public String toString() {
        return "CurrentWorldExpression";
      }
    ...
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.NRootExpression$sH, "r:9d14edd6-e1f4-4462-802b-9d9f72ed6bb8(jetbrains.mps.samples.Physics.plugin)/6539217963580481902", true, new TypedChildConstraintImpl(LINKS.exponent$SsDH, SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(CONCEPTS.RealType$5o))), new TypedChildConstraintImpl(LINKS.expression$tVRI, SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(CONCEPTS.RealType$5o)))) {
      public Object evaluateEvaluator(SNode node, IContext context, ICoverageAnalyzer coverage, ComputationTrace trace) {
        try {
          coverage.visitedEvaluator(this);
          coverage.visitedConcept(this.concept);
          coverage.visitedConcept(SNodeOperations.getConcept(node));
          return BigDecimal.valueOf(Math.pow(((BigDecimal) castUp(context.getRootInterpreter().evaluate(SLinkOperations.getTarget(node, LINKS.expression$tVRI), context, coverage, trace, false), BigDecimal.class)).doubleValue(), ((BigDecimal) castUp(context.getRootInterpreter().evaluate(SLinkOperations.getTarget(node, LINKS.exponent$SsDH), context, coverage, trace, false), BigDecimal.class)).doubleValue()));
        } catch (StopAndReturnException stop) {
          return stop.value();
        } catch (InterpreterEscapeException ex) {
          throw ex;
        } catch (RuntimeException ex) {
          throw new InterpreterRuntimeException("n-root(exponent[real], expression[real])", node, ex, trace);
        }
      }
      public EvaluatorInfo getInfo() {
