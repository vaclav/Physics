...
public class typeof_ObjectMassTarget_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode objectMassTarget, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:34dc5c2b-d71f-4a9a-9011-74cd28ad1a10(jetbrains.mps.samples.Physics.typesystem)", "7287056866554052088", true), (SNode) _quotation_createNode_ee5038_a1a0c0a0b(), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_ee5038_a1a0c0a0b() {
