...
public class UnitConversionUtil {
  ...
  public static SNode expressionToBase(SNode source, SNode sourceUnit) {
...

    {
      ...
      if (SNodeOperations.isInstanceOf(derived, CONCEPTS.DerivedUnit$zb)) {
        result = converter(source, derived, IUnitReferenceLike__BehaviorDescriptor.getRawExponent_id3031Xnpas0C.invoke(sourceUnit), true);
      }
    }

    // If the dimension is a composite one 
    {
      final SNode composite = UnitReference__BehaviorDescriptor.getDimension_ideHVwIHgU5$.invoke(sourceUnit);
      if (SNodeOperations.isInstanceOf(composite, CONCEPTS.CompositeDimension$ZV)) {
        // Apply conversion to base units of this  
        return createDivExpression_5ohk72_a1a5a2(result, decompose(composite).toString());
      }
    }
  ...
  public static SNode converter(SNode sourceExpression, SNode targetUnit, Number exponent, boolean targetToBase) {
    ...
    if (SPropertyOperations.getBoolean(targetUnit, PROPS.selfLeft$Z2EX) == targetToBase) {
      return createMulExpression_5ohk72_a0a1a6(SPropertyOperations.getString(targetUnit, PROPS.factor$Z2DZ), exponent.toString(), sourceExpression);
    } else {
      return createDivExpression_5ohk72_a0a0b0g(sourceExpression, SPropertyOperations.getString(targetUnit, PROPS.factor$Z2DZ), exponent.toString());
    }
  }
  private static SNode createDivExpression_5ohk72_a1a5a2(SNode p0, String p1) {
  ...
  private static SNode createMulExpression_5ohk72_a0a1a6(String p0, String p1, SNode p2) {
  ...
  private static SNode createDivExpression_5ohk72_a0a0b0g(SNode p0, String p1, String p2) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.DivExpression$Li);
    n0.forChild(LINKS.left$gQj0).initNode(p0, CONCEPTS.Expression$Wr, true);
    {
