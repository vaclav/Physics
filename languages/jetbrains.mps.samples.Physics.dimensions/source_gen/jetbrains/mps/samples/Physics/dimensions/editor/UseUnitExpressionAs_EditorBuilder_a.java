...
/*package*/ class UseUnitExpressionAs_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public UseUnitExpressionAs_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_gdt8cb_a");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "use as");
    editorCell.setCellId("Constant_gdt8cb_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "[");
    editorCell.setCellId("Constant_gdt8cb_b0");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new targetUnitsListHandler_gdt8cb_c0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
    editorCell.setCellId("refNodeList_targetUnits");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class targetUnitsListHandler_gdt8cb_c0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public targetUnitsListHandler_gdt8cb_c0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "]");
    editorCell.setCellId("Constant_gdt8cb_d0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
