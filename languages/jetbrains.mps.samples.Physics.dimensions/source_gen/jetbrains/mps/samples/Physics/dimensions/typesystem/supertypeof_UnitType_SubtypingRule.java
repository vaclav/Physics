...
public class supertypeof_UnitType_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  public supertypeof_UnitType_SubtypingRule() {
  }
  public List<SNode> getSubOrSuperTypes(SNode unitType, TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    for (SNode type : SetSequence.fromSet(supers)) {
      ListSequence.fromList(result).addElement(createDimensionType_30ns1u_a0a0a7a1(units, SNodeOperations.cast(type, CONCEPTS.Type$fA)));
    }
  ...
  private static SNode createDimensionType_30ns1u_a0a0a7a1(Iterable<? extends SNode> p0, SNode p1) {
