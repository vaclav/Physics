...
/*package*/ class IUnitReferenceLike_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public IUnitReferenceLike_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_asyv3v_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    editorCell.addEditorCell(createRefCell_0());
    if (nodeCondition_asyv3v_a1a()) {
      editorCell.addEditorCell(createCollection_1());
    }
    return editorCell;
  }
  private boolean nodeCondition_asyv3v_a1a() {
    return (SLinkOperations.getTarget(myNode, LINKS.exponent$2Bc0) != null);
  }
  ...
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_asyv3v_b0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_asyv3v_a1a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new exponentSingleRoleHandler_asyv3v_b1a(myNode, LINKS.exponent$2Bc0, getEditorContext());
    return provider.createCell();
  }
  private static class exponentSingleRoleHandler_asyv3v_b1a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public exponentSingleRoleHandler_asyv3v_b1a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
