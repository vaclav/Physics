...
public class TypesystemDescriptor extends BaseHelginsDescriptor {
  private static final Logger LOG = LogManager.getLogger(TypesystemDescriptor.class);
  ...
  public static class CustomOverloadedOperationsTypesProvider_a extends OverloadedOperationsTypesProvider {
    ...
    public boolean isApplicable(SubtypingManager subtypingManager, SNode operation, SNode leftOperandType, SNode rightOperandType) {
      LoggingRuntime.logMsgView(Level.INFO, "real and dimension !", TypesystemDescriptor.class, null, null);
      // Left operand must be a number 
      {
        ...
        if (SNodeOperations.isInstanceOf(number, CONCEPTS.NumberType$2D)) {
          ...
          LoggingRuntime.logMsgView(Level.INFO, ((double) range._0() == (double) range._1() && dimension && caps) + "", TypesystemDescriptor.class, null, null);
          return (double) range._0() == (double) range._1() && dimension && caps;
        }
      }

      LoggingRuntime.logMsgView(Level.INFO, "false", TypesystemDescriptor.class, null, null);
