...
/*package*/ class UnitReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    ...
    editorCell.setSubstituteInfo(new SReferenceSubstituteInfoSmartReferenceDecorator(new SReferenceSubstituteInfo(editorCell, referenceLink, CONCEPTS.IUnit$Ec)));
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new exponentSingleRoleHandler_tapd9e_a1a(myNode, LINKS.exponent$2Bc0, getEditorContext());
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink target$MhSC = MetaAdapterFactory.getReferenceLink(0x3571bff8cf914cd7L, 0xb8b7baa06abadf7cL, 0x73b48a125b0d4dc5L, 0x73b48a125b0daafcL, "target");
  ...
  private static final class CONCEPTS {
    /*package*/ static final SInterfaceConcept IUnit$Ec = MetaAdapterFactory.getInterfaceConcept(0x3571bff8cf914cd7L, 0xb8b7baa06abadf7cL, 0x73b48a125b0d40ceL, "jetbrains.mps.samples.Physics.dimensions.structure.IUnit");
