...
public final class Exponent__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Number> rawValue_id3yBD53Ww3_k = new SMethodBuilder<Number>(new SJavaCompoundTypeImpl(Number.class)).name("rawValue").modifiers(SModifiersImpl.create(12, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3yBD53Ww3_k").build();
