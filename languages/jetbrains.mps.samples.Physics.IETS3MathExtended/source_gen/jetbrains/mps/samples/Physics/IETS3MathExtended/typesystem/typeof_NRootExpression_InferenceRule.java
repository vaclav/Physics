...
public class typeof_NRootExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode nRootExpression, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      final SNode sqrtExpressionInnerType = typeCheckingContext.typeOf(SLinkOperations.getTarget(nRootExpression, LINKS.expression$tVRI), "r:eaef0861-3ed4-4442-afee-c90aaa3cdaec(jetbrains.mps.samples.Physics.IETS3MathExtended.typesystem)", "3773364508684486821", true);
      ...
      }, "r:eaef0861-3ed4-4442-afee-c90aaa3cdaec(jetbrains.mps.samples.Physics.IETS3MathExtended.typesystem)", "3773364508684486707", false, false);
    }
  }
