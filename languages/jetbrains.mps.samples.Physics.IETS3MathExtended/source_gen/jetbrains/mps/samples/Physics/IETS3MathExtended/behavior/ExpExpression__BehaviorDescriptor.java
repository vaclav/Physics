package jetbrains.mps.samples.Physics.IETS3MathExtended.behavior;
...
public final class ExpExpression__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf9bdc72399df40ffL, 0x934cd1f848158f92L, 0x7ee2c0df37c860b9L, "jetbrains.mps.samples.Physics.IETS3MathExtended.structure.ExpExpression");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return "exp(" + Expression__BehaviorDescriptor.renderReadable_id4Y0vh0cfqjE.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expr$xFwa)) + ")";
  }
