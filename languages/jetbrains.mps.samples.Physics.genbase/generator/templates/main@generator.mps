...
<model ref="r:7f849ccb-319a-4f74-b4b5-4d127a48b77f(main@generator)">
  <persistence version="9" />
  <languages>
    <devkit ref="a2eb3a43-fcc2-4200-80dc-c60110c4862d(jetbrains.mps.devkit.templates)" />
  </languages>
  <imports>
    <import index="wpa7" ref="r:c15caa44-4519-48df-8c03-cd289d6db44c(jetbrains.mps.samples.Physics.genbase.structure)" />
  ...
  <node concept="1pmfR0" id="10n4tqnDPuP">
    ...
    <node concept="1pplIY" id="10n4tqnDPuQ" role="1pqMTA">
      <node concept="3clFbS" id="10n4tqnDPuR" role="2VODD2">
        <node concept="3SKdUt" id="3PeuB2_Pvdj" role="3cqZAp">
          <node concept="1PaTwC" id="3PeuB2_Pvdk" role="1aUNEU">
            <node concept="3oM_SD" id="3PeuB2_Pvdl" role="1PaTwD">
              <property role="3oM_SC" value="Script" />
            </node>
            <node concept="3oM_SD" id="3PeuB2_Pvf4" role="1PaTwD">
              <property role="3oM_SC" value="to" />
            </node>
            <node concept="3oM_SD" id="3PeuB2_Pvfh" role="1PaTwD">
              <property role="3oM_SC" value="include" />
            </node>
            <node concept="3oM_SD" id="3PeuB2_PvfD" role="1PaTwD">
              <property role="3oM_SC" value="into" />
            </node>
            <node concept="3oM_SD" id="3PeuB2_PvfI" role="1PaTwD">
              <property role="3oM_SC" value="target" />
            </node>
            <node concept="3oM_SD" id="3PeuB2_Pvg8" role="1PaTwD">
              <property role="3oM_SC" value="languages" />
            </node>
            <node concept="3oM_SD" id="3PeuB2_Pvgz" role="1PaTwD">
          ...
          <node concept="2OqwBi" id="31HEEbc6HNn" role="3clFbG">
            <node concept="2OqwBi" id="31HEEbc6FDi" role="2Oq$k0">
              ...
              <node concept="2RRcyG" id="31HEEbc6FI2" role="2OqNvi">
                <node concept="chp4Y" id="2RqQV9hN3pF" role="3MHsoP">
