...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase {
  ...
  public Collection<ConceptEditor> getDeclaredEditors(SAbstractConcept concept) {
    ...
    switch (conceptIndex.index(cncpt)) {
      ...
      case 1:
        return Collections.<ConceptEditor>singletonList(new ForceType_Editor());
      case 2:
        return Collections.<ConceptEditor>singletonList(new LocalizedType_Editor());
      case 3:
        return Collections.<ConceptEditor>singletonList(new RotationType_Editor());
      case 4:
